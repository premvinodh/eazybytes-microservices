...
public class ResourceNotFoundException extends RuntimeException {
    ...
    /**
     * For the resourceName like loans we can't find the fieldName mobileNumber with the fieldValue say 9052417300
     * We are displaying a detailed error message -
     *      that we are trying to fetch loan details based on the
